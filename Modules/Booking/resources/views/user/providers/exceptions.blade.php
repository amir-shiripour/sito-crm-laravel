            ...
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                    ...
                    @if($provider->email)
                        ...
                        <span class="text-xs text-gray-500 dark:text-gray-400">{{ $provider->email }}</span>
                    @endif
                </p>
            </div>
        ...
        <form method="POST" action="{{ route('user.booking.providers.exceptions.store', $provider) }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="local_date" class="{{ $inputClass }}" data-jdp value="{{ old('local_date') }}">
                    @error('local_date')<div class="text-rose-600 dark:text-rose-400 text-xs mt-1">{{ $message }}</div>
                    @enderror
                </div>
                <div>
                    <label class="{{ $labelClass }}">این روز تعطیل باشد؟</label>
            ...
            <div class="mt-4 border-t border-gray-200 dark:border-gray-700 pt-4" x-show="isClosed == 0">
                <div class="flex items-center justify-between mb-3">
                    <h2 class="text-sm font-semibold text-gray-900 dark:text-gray-100">ساعات کاری ویژه این روز</h2>
                    <button type="button"
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full text-xs text-right">
                        ...
                        <tr>
                            ...
                            <th class="p-2 font-semibold text-gray-600 dark:text-gray-300">ساعات کاری</th>
                        ...
                        @forelse($exceptions as $ex)
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                                ...
                                <td class="p-2">
                                    ...
                                    @else
                                        <span
                                            class="px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-200 text-[11px]">باز</span>
                                    @endif
                                </td>
                                ...
                                <td class="p-2 text-gray-800 dark:text-gray-100">
                                    {{ $ex->override_capacity_per_day ?? '---' }}</td>
