    ...
    <div class="space-y-6 max-w-4xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">مشخصات، وضعیت و ترتیب نمایش این دسته‌بندی را بروزرسانی کنید.</p>
            </div>
        ...
        <form method="POST" action="{{ route('user.booking.categories.update', $category) }}" class="space-y-6">
            @csrf
            @method('PUT')
