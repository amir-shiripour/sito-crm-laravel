            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl max-w-lg w-full shadow-2xl border border-gray-100 dark:border-gray-700 relative overflow-hidden animate-in fade-in zoom-in-95 duration-200"
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div class="space-y-4 text-xs font-bold">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <div>
                                <label class="block text-gray-700 dark:text-gray-300 mb-1 flex items-center justify-between">
                                    ...
                                    @if($providerId)
                                        <span class="text-[10px] text-amber-600 dark:text-amber-400">وابسته به ارائه‌دهنده</span>
                                    @endif
                                </label>
                                <select wire:model.live="serviceId" class="w-full bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl px-3 py-2.5 text-xs font-bold text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-amber-500">
                            ...
                            <div>
                                <label class="block text-gray-700 dark:text-gray-300 mb-1 flex items-center justify-between">
                                    ...
                                    @if($serviceId)
                                        <span class="text-[10px] text-amber-600 dark:text-amber-400">وابسته به سرویس</span>
                                    @endif
                                </label>
                                <select wire:model.live="providerId" class="w-full bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl px-3 py-2.5 text-xs font-bold text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-amber-500">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="preferredDateJalali" placeholder="مثال: ۱۴۰۵/۰۶/۰۱" data-jdp-only-date
                                   class="w-full bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl px-3 py-2.5 text-xs font-bold text-gray-900 dark:text-gray-100 text-center focus:ring-2 focus:ring-amber-500">
                    ...
                    <div class="flex items-center justify-between gap-3 pt-4 border-t border-gray-100 dark:border-gray-700">
                        <button type="button" wire:click="closeModal" class="px-4 py-2.5 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-xl text-xs font-bold text-gray-700 dark:text-gray-200 transition">
                            انصراف
                        </button>
                        <button type="button" wire:click="save" wire:loading.attr="disabled"
                                class="inline-flex items-center gap-2 px-6 py-2.5 bg-amber-600 hover:bg-amber-700 text-white rounded-xl text-xs font-bold shadow-md shadow-amber-600/20 transition active:scale-95 disabled:opacity-50">
