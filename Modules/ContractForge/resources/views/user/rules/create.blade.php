...
@section('content')
    <div class="space-y-6">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-5">
            <div>
                <h1 class="text-xl font-bold text-gray-900 dark:text-gray-100">ایجاد قانون جدید</h1>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">تنظیم قوانین خودکار برای ایجاد قراردادها بر اساس موجودیت و شرط‌ها</p>
            </div>
            <div>
        ...
        <form action="{{ route('user.contracts.rules.store') }}" method="POST" id="ruleForm">
            @csrf
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-6 space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="name" required class="w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 px-4 py-2.5 text-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="مثال: قرارداد خودکار برای طرح اقساطی">
                            </div>
                            ...
                            <div>
                                ...
                                <select name="template_id" required class="w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 px-4 py-2.5 text-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    <option value="">انتخاب قالب قرارداد...</option>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center gap-3">
                                ...
                                <select name="conditions[operator]" class="rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-3 py-1 text-sm text-gray-900 dark:text-gray-100">
                                    <option value="AND">AND (همه شرط‌ها برقرار باشند)</option>
                                    <option value="OR">OR (حداقل یک شرط برقرار باشد)</option>
                                </select>
                            </div>
                ...
                <div class="space-y-6">
                    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <input type="number" name="priority" value="0" required class="w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 px-4 py-2.5 text-sm" placeholder="اعداد بزرگتر اولویت بالاتری دارند">
                        </div>
                        ...
                        <div class="space-y-4 pt-2">
                            <div class="flex items-center justify-between">
                                ...
                                <input type="checkbox" name="prevent_duplicate" value="1" checked class="h-4.5 w-4.5 rounded border-gray-350 text-indigo-650 focus:ring-indigo-500">
                            </div>
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    @foreach($statuses as $k => $v)
                                        <label class="flex items-center gap-2 p-2 rounded-lg border border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/50 cursor-pointer">
                                            <input type="checkbox" name="trigger_statuses[]" value="{{ $k }}" class="rounded border-gray-300 text-indigo-600">
    ...
    <script>
        ...
        // Add an initial empty condition row
        window.addEventListener('DOMContentLoaded', () => {
            addConditionRow({ field: 'installment_option_title', op: 'contains', value: 'اقساط' });
        });
    </script>
@endsection
