...
<div x-show="activeTab === 'widgets'" 
    ...
    <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border border-gray-200 dark:border-gray-700 rounded-2xl p-2 shadow-sm flex flex-wrap items-center gap-2">
        <button type="button" 
            ...
            <div :class="widgetTab === 'calendar' ? 'bg-rose-100 text-rose-600 dark:bg-rose-800/50 dark:text-rose-300' : 'bg-gray-100 text-gray-500 dark:bg-gray-700 dark:text-gray-400'" class="p-1 rounded-lg transition-colors">
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
            </div>
            <span>ویجت تقویم و رویدادها</span>
            <span class="px-2 py-0.5 text-[11px] font-bold rounded-md bg-rose-100/70 text-rose-700 dark:bg-rose-900/40 dark:text-rose-300">داشبورد</span>
        </button>
        ...
        <div class="{{ $cardClass }}">
            <div class="{{ $headerClass }}">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">پیکربندی ساختار و نحوه نمایش کارت تقویم در داشبورد کاربران</p>
                </div>
            </div>
        ...
        <div class="{{ $cardClass }}">
            ...
            <div class="{{ $headerClass }} justify-between flex-wrap gap-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-base font-bold text-gray-900 dark:text-white">همگام‌سازی و اتصال Google Calendar</h2>
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">پیکربندی اتصال مستقیم آنلاین OAuth2 یا ایمپورت آفلاین رویدادهای تقویم گوگل</p>
                    </div>
                </div>

                <div class="flex items-center gap-2">
                    @if($googleToken)
                        <span class="px-3 py-1 text-xs font-bold rounded-full bg-teal-100 text-teal-800 dark:bg-teal-900/40 dark:text-teal-300 flex items-center gap-1.5">
            ...
            <div class="px-6 pt-5 pb-0 bg-gray-50/30 dark:bg-gray-900/20 border-b border-gray-100 dark:border-gray-700/60">
                <div class="flex flex-wrap gap-2">
                    ...
                    <button type="button" 
                        ...
                        <span class="px-1.5 py-0.5 text-[10px] font-bold rounded bg-teal-100 dark:bg-teal-900/40 text-teal-800 dark:text-teal-300">آنلاین</span>
                    </button>
                    ...
                    <button type="button" 
                        ...
                        <span class="px-1.5 py-0.5 text-[10px] font-bold rounded bg-sky-100 dark:bg-sky-900/40 text-sky-800 dark:text-sky-300">فایل</span>
                    </button>
                </div>
            </div>
