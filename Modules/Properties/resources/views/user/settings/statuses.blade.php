{{-- properties::user.settings.statuses --}}
@php
    $title = 'مدیریت وضعیت‌های ' . config('properties.labels.singular');
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-xl font-bold text-gray-900 dark:text-gray-100">
                مدیریت وضعیت‌های {{ config('properties.labels.singular') }}
            </h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                تعریف و ویرایش وضعیت‌ها برای {{ config('properties.labels.plural') }}.
            </p>
        </div>
