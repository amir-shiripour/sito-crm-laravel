                        ...
                        <tr class="group hover:bg-gray-50 dark:hover:bg-gray-700/20 transition-colors">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 rounded-full bg-indigo-100 text-indigo-700 flex items-center justify-center font-bold text-sm dark:bg-indigo-900/50 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-800">
                                        <span x-text="(owner.first_name || '').charAt(0) + ' ' + (owner.last_name || '').charAt(0)"></span>
                                    </div>
                                    <span class="font-bold text-gray-900 dark:text-white" x-text="owner.first_name + ' ' + owner.last_name"></span>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <span class="font-mono text-gray-600 dark:text-gray-400 dir-ltr" x-text="owner.phone"></span>
                            </td>
                            ...
                            <td class="px-6 py-4 text-center text-gray-500 dark:text-gray-400 font-mono text-xs" x-text="new Date(owner.created_at).toLocaleDateString('fa-IR')"></td>
                            <td class="px-6 py-4">
