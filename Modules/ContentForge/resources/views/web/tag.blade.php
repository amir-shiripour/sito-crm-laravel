...
@section('title', 'برچسب: ' . $tag->name . ' - ' . $entity->name)
...
<div class="max-w-7xl mx-auto px-6 w-full flex-grow flex flex-col pt-32 pb-16">
    <div class="text-center max-w-2xl mx-auto space-y-4 mb-16">
        <span class="text-xs font-bold text-indigo-600 bg-indigo-50 dark:bg-indigo-950 px-3 py-1.5 rounded-full">برچسب مطالب</span>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        @empty
            <div class="col-span-full p-12 text-center text-gray-400">
                هیچ مطلبی با این برچسب منتشر نشده است.
            </div>
        @endforelse
    </div>
