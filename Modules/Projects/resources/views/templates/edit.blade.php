...
@section('content')
    <div class="p-4 sm:p-6 lg:p-8 space-y-6 max-w-7xl mx-auto"
        ...
        <div
            class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white dark:bg-gray-800/80 rounded-3xl p-6 border border-gray-100 dark:border-gray-700/50 shadow-xs">
            <div class="flex items-center gap-3.5">
                ...
                <div>
                    <div class="flex items-center gap-2 text-xs font-bold text-gray-400 mb-1">
                        <a href="{{ route('projects.templates.index') }}"
                           class="hover:text-indigo-600 transition-colors">الگوها</a>
                        <span>/</span>
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('projects.templates.show', $template) }}"
                   class="px-4 py-2.5 rounded-2xl bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 text-xs font-bold transition-all flex items-center gap-1.5 shadow-xs">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                        <path stroke-linecap="round" stroke-linejoin="round"
                              d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                    </svg>
                    <span>پیش‌نمایش الگو</span>
                </a>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('projects.templates.update', $template) }}"
            ...
            <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="text" name="title" x-model="form.title" required
                                   ...
                                   class="w-full rounded-2xl border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/50 px-4 py-2.5 text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 dark:text-white transition-all font-medium">
                            @error('title')
                        ...
                        {{-- Category --}}
                        <div class="space-y-1.5">
                            <label class="block text-xs font-bold text-gray-700 dark:text-gray-300">دسته‌بندی
                                (اختیاری)</label>
                        ...
                        <div class="sm:col-span-2 space-y-1.5">
                            <label class="block text-xs font-bold text-gray-700 dark:text-gray-300">توضیحات یا نکات
                                الگو</label>
                            <textarea name="description" x-model="form.description" rows="2"
                                      placeholder="توضیحاتی در مورد کاربرد این الگو بنویسید..."
                ...
                {{-- TOP ACTION BAR --}}
                <div
                    class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white dark:bg-gray-800/80 rounded-3xl p-5 border border-gray-100 dark:border-gray-700/50 shadow-xs">
                    <div>
                        <h3 class="text-sm font-black text-gray-900 dark:text-white flex items-center gap-2">
                            <svg class="w-4 h-4 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                 stroke-width="2">
                            ...
                            مدیریت فازها، گروه‌ها و کارها در این الگو
                        </h3>
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-3 min-w-0 flex-1">
                                    ...
                                    <div class="relative flex items-center justify-center shrink-0"
                                         title="تغییر رنگ فاز">
                                        <span
                                            class="w-4 h-4 rounded-full shadow-xs cursor-pointer block border border-black/10"
                ...
                <div
                    ...
                    <button type="submit"
                            class="px-8 py-3 rounded-2xl bg-amber-500 hover:bg-amber-600 text-white text-xs sm:text-sm font-bold shadow-md shadow-amber-500/25 transition-all flex items-center gap-2">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/>
                        </svg>
                        <span>ذخیره تغییرات الگو</span>
                    </button>
                </div>
            </div>
        </form>
