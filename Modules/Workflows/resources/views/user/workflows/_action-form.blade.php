@php
    ...
    $defaultTokens = [
        ...
        'payment' => [
            ...
            'payment_invoice_number' => 'شماره فاکتور مرتبط',
            'payment_invoice_total' => 'مبلغ کل فاکتور مرتبط',
            'payment_invoice_remaining' => 'مانده فاکتور مرتبط',
            'payment_invoice_is_paid' => 'آیا فاکتور پرداخت شده؟',
