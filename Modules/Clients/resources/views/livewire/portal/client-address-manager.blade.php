        ...
        <form wire:submit.prevent="saveAddress" class="space-y-6">
            ...
            <div class="relative">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="address-province-input" class="block mb-2 text-sm font-semibold text-gray-800 dark:text-gray-200">استان</label>
                        <input type="text" id="address-province-input" wire:model="province" class="w-full rounded-xl border-gray-200 bg-gray-50 px-4 py-2.5 text-sm text-gray-900 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-500/20 transition-all dark:border-gray-700 dark:bg-gray-900/50 dark:text-gray-100 dark:focus:bg-gray-900">
                        @error('province') <span class="text-xs text-red-500 mt-1 block">{{ $message }}</span> @enderror
                    </div>

                    <div>
                        <label for="address-city-input" class="block mb-2 text-sm font-semibold text-gray-800 dark:text-gray-200">شهر</label>
                        <input type="text" id="address-city-input" wire:model="city" class="w-full rounded-xl border-gray-200 bg-gray-50 px-4 py-2.5 text-sm text-gray-900 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-500/20 transition-all dark:border-gray-700 dark:bg-gray-900/50 dark:text-gray-100 dark:focus:bg-gray-900">
