    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-xl shadow-gray-200/40 dark:shadow-none overflow-hidden">
        ...
        <div class="flex items-center justify-between px-6 py-5 border-b border-gray-100 dark:border-gray-700 bg-gray-50/30 dark:bg-gray-800">
            ...
            <a href="{{ route('user.clients.index') }}"
               class="group inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white border border-gray-200 text-sm font-medium text-gray-600 hover:border-gray-300 hover:bg-gray-50 hover:text-gray-400 dark:hover:text-gray-300 transition-all dark:bg-gray-700 dark:border-gray-800 dark:text-gray-200 dark:hover:bg-gray-600">
                <svg class="w-4 h-4 text-gray-400 group-hover:text-gray-300 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="p-6 sm:p-8 space-y-8">
            ...
            @if(empty($fields))
                ...
                <div class="text-center py-12 bg-gray-50 rounded-2xl border border-dashed border-gray-300 dark:bg-gray-900 dark:border-gray-700">
                ...
                @foreach($grouped as $groupName => $groupFields)
                    <section class="space-y-4">
                        <div class="flex items-center gap-2 mb-4 pb-1 border-b border-gray-100 dark:border-gray-700">
                            <span class="flex items-center justify-center w-6 h-6 rounded-full bg-indigo-100 text-indigo-600 text-xs font-bold dark:bg-indigo-900/50 dark:text-indigo-300">
                                {{ $loop->iteration }}
                            </span>
