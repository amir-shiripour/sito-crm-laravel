...
@section('content')
    ...
    <form action="{{ route('admin.accounting.cheques.store') }}" method="POST" x-data="chequeForm()">
        @csrf
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-2 mr-14 max-w-2xl leading-relaxed">
                        اطلاعات چک جدید را در این فرم وارد کنید. فیلد های ستاره دار اجباری هستند.
                    </p>
                </div>
            </div>
            ...
            <div class="{{ $cardClass }}">
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="type" id="type" class="{{ $selectClass }}" x-model="type" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="amount" id="amount" value="{{ old('amount') }}" class="{{ $inputClass }} dir-ltr text-left" @input="formatAmount($el)" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="bank_name" id="bank_name" value="{{ old('bank_name') }}" class="{{ $inputClass }}" required>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="payee_name" id="payee_name" value="{{ old('payee_name') }}" class="{{ $inputClass }}" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="cheque_number" id="cheque_number" value="{{ old('cheque_number') }}" class="{{ $inputClass }} dir-ltr text-left">
                    ...
                    <div>
                        ...
                        <input type="text" name="sayyad_id" id="sayyad_id" value="{{ old('sayyad_id') }}" class="{{ $inputClass }} dir-ltr text-left" maxlength="16">
                    ...
                    <div>
                        ...
                        <input type="text" name="issue_date" id="issue_date" data-jdp value="{{ old('issue_date', jdate()->format('Y/m/d')) }}" class="{{ $inputClass }} dir-ltr text-center" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="due_date" id="due_date" data-jdp value="{{ old('due_date', jdate()->format('Y/m/d')) }}" class="{{ $inputClass }} dir-ltr text-center" required>
                    ...
                    {{-- Bank Account --}}
                    <div class="md:col-span-1" x-show="type === 'issued'" x-transition>
    ...
    @push('scripts')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                // bank_id is conditionally shown, TomSelect might have issues if initialized while hidden.
                // It's safer to just let it be a standard select or manage its visibility carefully.
                // Given the requirement, keeping it standard is safer when using x-show.
            });

            function chequeForm() {
                return {
                    type: '{{ old('type', 'received') }}',
                    init() {
                     ...
                     */
                    formatAmount(el) {
                        // 1. Convert all digits to English and remove non-numeric characters (except decimal point)
