        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 pb-24">
            ...
            <div class="{{ $cardClass }}">
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="amount" class="{{ $labelClass }}">مبلغ چک ({{ $currencySuffix }}) <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        ...
                        <input type="text" name="branch_name" id="branch_name" value="{{ old('branch_name', $cheque->branch_name) }}" class="{{ $inputClass }}">
