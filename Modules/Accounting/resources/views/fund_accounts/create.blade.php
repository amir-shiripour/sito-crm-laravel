            ...
            <div class="{{ $cardClass }}">
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" class="{{ $inputClass }}" required>
                    ...
                    @php
                        $selectedFundCatId = old('category_id');
                    ...
                    <template x-if="selectedType === 'bank'">
                        <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6 border-t border-gray-100 dark:border-gray-700 pt-6 mt-6">
                            <div>
                                ...
                                <input type="text" name="bank_name" id="bank_name" value="{{ old('bank_name') }}" class="{{ $inputClass }}">
                            ...
                            <div>
                                ...
                                <input type="text" name="account_holder_name" id="account_holder_name" value="{{ old('account_holder_name') }}" class="{{ $inputClass }}">
                            ...
                            <div>
                                ...
                                <input type="text" name="account_number" id="account_number" value="{{ old('account_number') }}" dir="ltr" style="direction: ltr;" class="{{ $inputClass }} text-left" @input="sanitizeNumber($el)">
                            ...
                            <div>
                                ...
                                <input type="text" name="card_number" id="card_number" value="{{ old('card_number') }}" maxlength="16" dir="ltr" style="direction: ltr;" class="{{ $inputClass }} text-left" @input="sanitizeNumber($el)">
                            ...
                            <div>
                                ...
                                <input type="text" name="iban" id="iban" value="{{ old('iban') }}" maxlength="26" dir="ltr" style="direction: ltr;" class="{{ $inputClass }} text-left" placeholder="IR123456789012345678901234">
                    ...
                    <template x-if="selectedType === 'gateway'">
                        <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6 border-t border-gray-100 dark:border-gray-700 pt-6 mt-6">
                            <div>
                                ...
                                <input type="number" name="core_gateway_id" id="core_gateway_id" value="{{ old('core_gateway_id') }}" class="{{ $inputClass }}">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="notes" id="notes" rows="3" class="{{ $inputClass }}">{{ old('notes') }}</textarea>
