            ...
            <div class="{{ $cardClass }}">
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $fundAccount->name) }}"
                    ...
                    <div>
                        ...
                        <select name="type" id="type" x-model="selectedType" class="{{ $inputClass }}" required>
                            ...
                            @foreach($types as $value => $label)
                                <option
                                    value="{{ $value }}" {{ old('type', $fundAccount->type) == $value ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div x-data="{
                            open: false,
                            search: '',
                            selectedId: '{{ old('category_id', $fundAccount->category_id) }}',
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <input type="text" name="bank_name" id="bank_name"
                                       value="{{ old('bank_name', $fundAccount->bank_name) }}"
                                       class="{{ $inputClass }}">
                            ...
                            <div>
                                ...
                                <input type="text" name="branch_name" id="branch_name"
                                       value="{{ old('branch_name', $fundAccount->branch_name) }}"
                                       class="{{ $inputClass }}">
                            ...
                            <div>
                                ...
                                <input type="text" name="account_holder_name" id="account_holder_name"
                                       value="{{ old('account_holder_name', $fundAccount->account_holder_name) }}"
                                       class="{{ $inputClass }}">
                            ...
                            <div>
                                ...
                                <input type="text" name="account_number" id="account_number"
                                       value="{{ old('account_number', $fundAccount->account_number) }}" dir="ltr"
                                       style="direction: ltr;" class="{{ $inputClass }} text-left"
                                       @input="sanitizeNumber($el)">
                            ...
                            <div>
                                ...
                                <input type="text" name="card_number" id="card_number"
                                       value="{{ old('card_number', $fundAccount->card_number) }}" maxlength="16"
                            ...
                            <div>
                                ...
                                <input type="text" name="iban" id="iban" value="{{ old('iban', $fundAccount->iban) }}"
                                       maxlength="26" dir="ltr" style="direction: ltr;"
                                       class="{{ $inputClass }} text-left" placeholder="IR123456789012345678901234">
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <input type="number" name="core_gateway_id" id="core_gateway_id"
                                       value="{{ old('core_gateway_id', $fundAccount->core_gateway_id) }}"
                                       class="{{ $inputClass }}">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="notes" id="notes" rows="3"
                                  class="{{ $inputClass }}">{{ old('notes', $fundAccount->notes) }}</textarea>
                        @error('notes')<p class="mt-2 text-sm text-red-600">{{ $message }}</p>@enderror
                    </div>

                    <div x-data="{ status: {{ old('status', $fundAccount->status) ? 'true' : 'false' }} }"
                         class="md:col-span-2">
