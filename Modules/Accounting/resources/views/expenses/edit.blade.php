...
<form action="{{ route('admin.accounting.expenses.update', $expense) }}" method="POST" enctype="multipart/form-data" x-data="formHandlers()" @submit="if (!isTotalAllocatedBalanced) { $event.preventDefault(); return false; }">
    @csrf
    @method('PUT')
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">نمایش زنده موجودی فعلی،
                                        تفکیک مبالغ کسر در این سند و موجودی نهایی پس از به‌روزرسانی هزینه</p>
                                </div>
                            </div>
                        </div>
