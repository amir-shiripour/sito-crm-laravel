...
@section('title', 'افزودن حساب بانکی')
...
@section('content')
    <form action="{{ route('admin.accounting.banks.store') }}" method="POST" x-data="formHandlers()">
        @csrf
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-2 mr-14 max-w-2xl leading-relaxed">
                        اطلاعات حساب بانکی جدید را در این فرم وارد کنید.
                    </p>
                </div>
            </div>
            ...
            <div class="{{ $cardClass }}">
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="account_holder_name" id="account_holder_name" value="{{ old('account_holder_name') }}" class="{{ $inputClass }}" required>
                        @error('account_holder_name')<p class="mt-2 text-sm text-red-600">{{ $message }}</p>@enderror
                    </div>
                    <div>
                        <label for="balance" class="{{ $labelClass }}">موجودی اولیه</label>
                        <input type="text" name="balance" id="balance" value="{{ old('balance', 0) }}" class="{{ $inputClass }} dir-ltr text-left" @input="formatNumber($el)">
                    ...
                    <div>
                        ...
                        <input type="text" name="account_number" id="account_number" value="{{ old('account_number') }}" class="{{ $inputClass }} dir-ltr text-left" @input="sanitizeNumber($el)">
                    ...
                    <div>
                        ...
                        <input type="text" name="card_number" id="card_number" value="{{ old('card_number') }}" maxlength="16" class="{{ $inputClass }} dir-ltr text-left" @input="sanitizeNumber($el)">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="iban" id="iban" value="{{ old('iban') }}" maxlength="26" class="{{ $inputClass }} dir-ltr text-left" placeholder="IR123456789012345678901234">
    ...
    <script>
        function formHandlers() {
            return {
                selectedColor: '{{ old('color', $colors[0]) }}',
                sanitizeNumber(el) {
