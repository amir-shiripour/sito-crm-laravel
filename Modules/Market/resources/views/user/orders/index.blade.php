                    ...
                    @forelse($orders ?? [] as $order)
                        <tr class="group hover:bg-gray-50 dark:hover:bg-gray-700/20 transition-colors duration-150">
                            ...
                            <td class="px-4 py-3 text-gray-900 dark:text-gray-100">
                                {{ optional($order->client)->name ?? 'کاربر ناشناس' }}
                             </td>
                             ...
                             <td class="px-4 py-3 text-left">
                                 <a href="{{ route('user.market.orders.show', $order) }}" class="p-1.5 inline-block rounded-lg text-blue-600 hover:bg-blue-50 dark:text-blue-400 dark:hover:bg-blue-900/20" title="مشاهده فاکتور">
