{{-- resources/views/admin/custom_fields/edit.blade.php --}}
@extends('layouts.user')

@php
    $title = 'ویرایش فیلد سفارشی: ' . $field->label;
...
@section('content')
    <div class="max-w-4xl mx-auto px-4 py-8 space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            <div>
                ...
                <span class="flex items-center justify-center w-8 h-8 rounded-lg bg-amber-100 text-amber-600 dark:bg-amber-500/20 dark:text-amber-300">
                    ...
                    ویرایش فیلد: {{ $field->label }}
                </h1>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1 mr-10">به‌روزرسانی مشخصات و تنظیمات فیلد اختصاصی</p>
            </div>
        ...
        <form method="POST" action="{{ route('admin.custom-fields.update', $field) }}" class="space-y-6 pb-20" x-data="{ isSubmitting: false, showAdvanced: false }" @submit="isSubmitting = true">
            @csrf
            @method('PUT')
            ...
            <div class="{{ $cardClass }}">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="label" value="{{ old('label', $field->label) }}" class="{{ $inputClass }}" required>
                    </div>
            ...
            <div class="flex items-center justify-between sticky bottom-6 z-40 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md p-4 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-xl">
                ...
                <button type="submit"
                    ...
                    <span x-show="!isSubmitting">ذخیره تغییرات</span>
